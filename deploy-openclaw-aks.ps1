...
Write-Host "  kubectl cp `"C:\Users\YourUsername\Downloads\BookTitle.pdf`" openclaw/openclaw:/home/node/.openclaw/book-to-skill/books/ -c openclaw" -ForegroundColor White
Write-Host ""
Write-Host "  Or for EPUB files:" -ForegroundColor Gray
Write-Host "  kubectl cp `"C:\Users\YourUsername\Downloads\BookTitle.epub`" openclaw/openclaw:/home/node/.openclaw/book-to-skill/books/ -c openclaw" -ForegroundColor White
Write-Host ""
