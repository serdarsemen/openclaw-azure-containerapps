...
If you use `-OllamaWindows`, use `start-ollama-windows.ps1` to start Ollama on the host with proper `0.0.0.0:11434` binding. The WSL deploy script will not auto-start native Ollama.
